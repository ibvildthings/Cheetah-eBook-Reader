        ...
        this._linkClickHandler = (e) => {
            ...
            if (targetElement) {
                ...
                setTimeout(() => {
                    ...
                    const visibleWords = contentArea.querySelectorAll('.flow-word');
                        ...
                        if (readerArea) {
                            ...
                            for (let i = 0; i < visibleWords.length; i++) {
                                ...
                                if (wordTop >= viewportTop) {
                                    ...
                                    const wordIndex = parseInt(word.dataset.wordIndex, 10);
                                    if (!isNaN(wordIndex) && this.reader && this.reader.state) {
                                        console.log(`📍 Setting word index to ${wordIndex} after link navigation`);
                                        // Directly set the word index in the reader's state
                                        // This ensures it's preserved when play() is called
